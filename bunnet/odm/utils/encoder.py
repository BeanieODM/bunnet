...
from bunnet.odm.utils.pydantic import IS_PYDANTIC_V2, get_model_fields
...
class Encoder:
    ...
    def _encode_document(self, obj: "bunnet.Document") -> Mapping[str, Any]:
        obj.parse_store()
    ...
    def encode(self, obj: Any) -> Any:
        ...
        if isinstance(obj, bunnet.Document):
