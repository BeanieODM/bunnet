...
from bunnet.odm.utils.find import construct_lookup_queries, split_text_query
...
class FindQuery(
    ...
    UpdateQueryType: type[UpdateQuery] | type[UpdateMany] | type[UpdateOne] = UpdateQuery
...
class FindMany(
    ...
    def sort(
        self,
        *args: str | tuple[str, SortDirection] | list[tuple[str, SortDirection]] | None,
    ) -> "FindMany[FindQueryResultType]":
        """
        Add sort parameters
    ...
    def first_or_none(self) -> FindQueryResultType | None:
        """
