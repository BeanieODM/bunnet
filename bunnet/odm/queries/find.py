...
from bunnet.odm.utils.relations import convert_ids
...
class FindMany(
    ...
    def delete_many(
        ...
        **pymongo_kwargs,
        ...
        """
        Provide search criteria to the [DeleteMany](https://roman-right.github.io/bunnet/api/queries/#deletemany) query

        :param session:
        :return: [DeleteMany](https://roman-right.github.io/bunnet/api/queries/#deletemany) query
        """
    ...
    def aggregate(
        ...
        **pymongo_kwargs,
        ...
        """
        Provide search criteria to the [AggregationQuery](https://roman-right.github.io/bunnet/api/queries/#aggregationquery)
...
class FindOne(FindQuery[FindQueryResultType], RunInterface):
    ...
    def update_one(
        ...
        **pymongo_kwargs,
        ...
        """
        Create [UpdateOne](https://roman-right.github.io/bunnet/api/queries/#updateone) query using modifications and
    ...
    def delete_one(
        ...
        **pymongo_kwargs,
        ...
        """
        Provide search criteria to the [DeleteOne](https://roman-right.github.io/bunnet/api/queries/#deleteone) query
        :param session: Optional[ClientSession] - PyMongo sessions
        :return: [DeleteOne](https://roman-right.github.io/bunnet/api/queries/#deleteone) query
        """
        # We need to cast here to tell mypy that we are sure about the type.
        # This is because delete may also return a DeleteOne type in general, and mypy can not be sure in this case
        # See https://mypy.readthedocs.io/en/stable/common_issues.html#narrowing-and-inner-functions
    ...
    def replace_one(
        ...
        :param session: Optional[ClientSession] - PyMongo session
        :param bulk_writer: Optional[BulkWriter] - bunnet bulk writer
        :return: UpdateResult
        """
        self.set_session(session=session)
