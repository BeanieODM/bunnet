...
please open an issue on the GitHub page - <https://github.com/roman-right/bunnet>
...
Bunnet uses the single aggregation query under the hood to fetch all the linked documents. 
